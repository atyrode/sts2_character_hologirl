...
- Tuner ranges are intentionally broad while calibrating: X `-500..2600`, Y `-700..1200`, scale `0.10..3.50`, particle densities `0..10`, gold jitter `0..160`, hologram tint/shimmer/scanline `0..1.5`, tear `0..0.030`, tear frequency `0.25..5.0`, scan speed `-5..5`, and scan spacing `4..180`.
- Confirmed tester-preferred temporary framing values: X `821`, Y `94`, scale `1.53`, whip density `5.0`, drift density `5.0`, gold jitter `80`, hologram tint `1.0`, tear `0.0`, tear frequency `4.0`, shimmer `0.04`, scanline `0.34`, scan speed `0.43`, scan spacing `87.0`, background `Periwinkle Drift`, character `Thin Outline Compact`. These are now the tuner defaults until replaced by final constants.
