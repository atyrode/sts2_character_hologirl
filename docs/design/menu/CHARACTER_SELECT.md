...
- Confirmed tester-preferred temporary framing values: X `842`, Y `120`, scale `1.51`, whip density `5.0`, drift density `1.3`, gold jitter `80`, hologram tint `0.45`, tear `0.0`, tear frequency `24.0`, shimmer `0.43`, scanline `0.09`, scan speed `0.47`, scan spacing `26.0`, background `Periwinkle Drift`, character `Thin Outline Angular`. These are now the tuner defaults until replaced by final constants.
