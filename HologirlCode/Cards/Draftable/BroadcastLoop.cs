...
public sealed class BroadcastLoop() : HologirlCard(1, CardType.Power, CardRarity.Common, TargetType.Self)
{
    protected override IEnumerable<DynamicVar> CanonicalVars => [new PowerVar<BroadcastLoopPower>(1)];
